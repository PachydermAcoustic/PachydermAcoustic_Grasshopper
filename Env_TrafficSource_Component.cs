...
namespace PachydermGH
{
    public class Trafficsource_Component : GH_Component
    {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            S = new Pachyderm_Acoustic.Environment.LineSource(Samples, (Origin.Value as Curve).GetLength(), Pachyderm_Acoustic.Utilities.PachTools.EncodeSourcePower(SWL), el_m, 0);
