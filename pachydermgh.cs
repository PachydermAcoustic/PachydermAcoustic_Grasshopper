...
{
    public class PachydermGH : GH_Component
    {
        /// <summary>
        ...
        {
            pManager.AddTextParameter("Room Model", "Room", "The Pachyderm Room Model Reference", GH_ParamAccess.item);
        ...
        {
            pManager.AddCurveParameter("Reflections", "Paths", "Curves indicating the Snell's Law paths of sound.", GH_ParamAccess.list);
        }
