...
namespace PachydermGH
{
    public class StationaryReceiver_Component : GH_Component
    {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            {
                Pachyderm_Acoustic.Environment.Receiver_Bank RB = new Pachyderm_Acoustic.Environment.Receiver_Bank(H_Origin, Srcs[i].Origin(), S, Fs, COTime, Pachyderm_Acoustic.Environment.Receiver_Bank.Type.Stationary); 
                DA.SetData(0, RB);
            }
        }
