...
{
    [IoId("903EC2CF-FD15-4A55-8A08-E34A0322A3EE")]
    public class Lombard_RT : Component
    {
        ...
        /// </summary>
        public Lombard_RT()
            : base(new Nomen("Lombard Effect (RT,V)",
        ...
        {
            inputs.AddNumber("Reverb Time", "RT", "Reverberation Time", Access.Tree);
            inputs.AddNumber("Volume", "V", "Volume of the room", Access.Item);
        ...
        protected override void Process(IDataAccess access)
        {
            ...
            access.GetItem<double>(2, out No_of_People);
            Tree<double> Noise_T;
            access.GetTree<double>(3, out Noise_T);
